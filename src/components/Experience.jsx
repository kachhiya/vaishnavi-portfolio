        ...
        >
            <div className="w-[85%] flex flex-col items-center">
                ...
                <div className="relative">
                    {/* Vertical line */}
                    <div className="absolute left-2.5 sm:left-4 lg:left-4.8 top-0 h-full w-[2px] bg-purple-500/40"></div>
                        ...
                        {experiences.map((exp, index) => (
                            <div key={index} className="relative flex gap-10">
                                ...
                                <div className="relative z-10 flex-shrink-0">
                                    <div className=" w-6 h-6 sm:w-6.5 sm:h-6.5 lg:w-8 lg:h-8 rounded-full bg-purple-500
  "></div>
                                </div>
